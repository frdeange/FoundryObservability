"""
Example 02 — Tracing to Aspire Dashboard (Async)

Async variant: sends traces to the Aspire Dashboard via OTLP gRPC.

Prerequisites:
    docker compose up -d   (or the devcontainer auto-starts it)

Usage:
    python examples/02_tracing_aspire_dashboard/tracing_aspire_async.py
        ...
        async with (
            ...
            async with project_client.get_openai_client() as openai_client:
                agent = await project_client.agents.create_version(
                    agent_name="TracingAspireDemoAsync",
